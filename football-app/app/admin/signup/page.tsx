...
export default function AdminSignupPage() {
  ...
  const popularTeams = [
    "Lagos United", "Kano Pillars", "Rivers United", "Enyimba FC", "Plateau United", "Heartland FC",
    "Shooting Stars", "Lobi Stars", "Akwa United", "Nasarawa United",
  ]
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Create a Football Hub admin account</p>
          </div>
